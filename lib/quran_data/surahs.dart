...
bool isSurahLastLine(int pageIdx, int lineIdx, Mushaf m) {
  final surahLastLine = switch (m) {
    Mushaf.Indopak16Line => surahLastLine16,
    Mushaf.Uthmani15Line => surahLastLine15Uthmani,
    Mushaf.Indopak15Line => surahLastLine15Indo,
    Mushaf.Indopak13Line => surahLastLine13,
  };
  return surahLastLine[pageIdx]?.contains(lineIdx) ?? false;
}

const Map<int, List<int>> surahLastLine13 = {
  66: [0],
  104: [3],
  145: [0],
  175: [7],
...
const Map<int, List<int>> surahLastLine15Indo = {
  48: [14],
  75: [14],
  105: [4],
  126: [14],
...
const Map<int, List<int>> surahLastLine16 = {
  44: [2],
  68: [11],
  95: [0],
  114: [7],
